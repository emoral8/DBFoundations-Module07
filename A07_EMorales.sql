...
-- 2024-29-05,Elizabeth Morales,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_EMorales')
	 Begin 
	  Alter Database [Assignment07DB_EMorales] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_EMorales;
	 End
	Create Database Assignment07DB_EMorales;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_EMorales;
...
Select ProductName, UnitPrice = Format(P.UnitPrice, 'C', 'en-us')
FROM vProducts AS p
Order By 1
...
-- Varify that the results are ordered by the Product and Date.
Create -- Drop
Function fProductInventoriesWithPreviousMonthCountsWithKPIs (@CPIValue int)
Returns Table
 AS
  Return Select
   ProductName,
 ...
 From vProductInventoriesWithPreviousMonthCountsWithKPIs
  Where CountVsPreviousCountKPI = @CPIValue
go
